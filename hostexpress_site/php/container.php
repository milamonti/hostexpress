...
<div id="container" class="w-100">
  <div class="container-fluid bg-white text-primary">
    <div class="row">
      <div class="col-md-12">
        <img src="./assets/1.png" class="d-block w-100" height="100">    
      </div>
  ...
  <div class="container-fluid">
    <div id="cardCarousel" class="carousel slide">
      <div class="carousel-inner p-3" id="carousel-content"></div>
  ...
  <!--Carousel Images-->
  <div id="carouselImages" class="carousel slide w-100 mt-3" data-bs-ride="carousel" style="height: 200px;">
    <div class="carousel-inner w-100">
      <div class="carousel-item active">
        <img src="./assets/2.png" class="d-block w-100" alt="..." height="100">
      </div>
      <div class="carousel-item">
        <img src="./assets/3.png" class="d-block w-100" alt="..." height="100">
      </div>
      <div class="carousel-item">
        <img src="./assets/4.png" class="d-block w-100" alt="..." height="100">
      </div>
    </div>
