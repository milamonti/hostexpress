...
import static telas.conexao.email;
...
public class tela_empresa extends javax.swing.JFrame {
    ...
    public tela_empresa(String email) {
        initComponents();
        conexao.Conectar();
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(ftfcpf)
                                        .addComponent(ComboEsp, 0, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            String sql = "UPDATE he_empresas set CNPJ = ?, NOME_FANTASIA = ?,ESPECIALIDADE = ?, CEP = ?, ENDERECO = ?, ENDERECO_NUM = ?, BAIRRO = ?, CIDADE = ?, CONFIRMADA = ?, ATIVO = ?, TELEFONE = ?, COMPLEMENTO = ?, PERMISSAO = ?)"
            + "where email = ?";
            PreparedStatement stm = con.prepareStatement(sql);
            stm.setString(1, ftfcnpj.getText().replaceAll("[^\\d]",""));
            stm.setString(2, tfrazao.getText());
            stm.setString(3, (String) ComboEsp.getSelectedItem());
            stm.setString(4, ftfcep.getText().replaceAll("[^\\d]",""));
            stm.setString(5, tfendereco.getText());
            stm.setString(6, tfnum.getText());
            stm.setString(7, tfbairro.getText());
            stm.setString(8, tfcidade.getText());
            stm.setString(9, "N");
            stm.setString(10, "N");
            stm.setString(11, ftftelefone1.getText().replaceAll("[^\\d]",""));
            stm.setString(12, tfcompl.getText());
            stm.setString(13, "EMPRESA");
            stm.setString(14, email);
            int rs = stm.executeUpdate();
            JOptionPane.showMessageDialog(null, rs > 0 ? "Agradecemos seu cadastro!\nEle será analisado e você receberá um E-mail com a confirmação!"
                    : "Erro ao enviar seu cadastro!");
        }
        catch(SQLException e){
            JOptionPane.showMessageDialog(null, "Erro ao inserir seu cadastro!");
    ...
    public static void main(String args[], String email) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
                new tela_empresa(email).setVisible(true);
        });
    }
